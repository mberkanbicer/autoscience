...
class PaperSource(BaseModel):
    ...
    paper_id: Mapped[str] = mapped_column(nullable=False, index=True)
...
class ClusterLabel(BaseModel):
    ...
    cluster_id: Mapped[str] = mapped_column(nullable=False, index=True)
...
class ClusterConflict(BaseModel):
    ...
    project_id: Mapped[str] = mapped_column(nullable=False, index=True)
    cluster_id: Mapped[str | None] = mapped_column(nullable=True, index=True)
